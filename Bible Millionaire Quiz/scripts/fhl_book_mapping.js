...
export {
  ...
  getFHLCode,
  getFHLChapterCount
} from '../server/domains/content/bible/fhlCatalog.js';

import { FHL_BOOKS, getFHLCode } from '../server/domains/content/bible/fhlCatalog.js';

// API 使用的英文縮寫 (用於 sg.php?engs=...)
export const FHL_ENGS = {
...
export function getFHLEngs(bookName) {
  return FHL_ENGS[bookName] || null;
}

export default { FHL_BOOKS, FHL_ENGS, getFHLCode, getFHLEngs };
